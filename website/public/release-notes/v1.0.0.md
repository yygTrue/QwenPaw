...
- **Download Page**: New downloads page for desktop installers with mirror sites ([#2555](https://github.com/agentscope-ai/CoPaw/pull/2555))
...
- **Website UI Refactoring**: Major website UI refactoring for improved internationalization and modern styling ([#2558](https://github.com/agentscope-ai/CoPaw/pull/2558))
